	...
	return (
		<div className='w-full h-screen bg-zinc-200 flex flex-col justify-between '>
			<div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
				<div className='flex flex-col justify-center md:itemes-start w-full px-2 py-8'>
					<p className='text-2xl'>Unique Sequencing & Productivity</p>
				...
				<div className='absolute flex flex-col py-8 md:min-w-[760px] bottom-[-5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl'>
					...
					<div className="flex justify-between flex-wrap px-4">
						...
						<p className="flex px-4 py-2 text-slate-500"><PaperAirplaneIcon className="transform rotate-90 h-6 text-indigo-600"/>. API</p>
					</div>
				</div>
			</div>
		</div>
